  ...
  return (
    <Layout>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <a href="/simulados" className="bg-white rounded-xl shadow-sm p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
        ...
        <a  href="/ranking" className="bg-white rounded-xl shadow-sm p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
          <span className="text-4xl">🏅</span>
          <div>
        ...
        <a href="/estatisticas" className="bg-white rounded-xl shadow-sm p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
          <span className="text-4xl">📊</span>
          <div>
      ...
      <div className="mt-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 text-center text-gray-500">
          ...
          <a href="/simulados" className="inline-block mt-4 text-blue-600 hover:text-blue-700 font-medium">
            Começar agora
          </a>
        </div>
      </div>
